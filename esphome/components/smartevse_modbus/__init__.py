...
CONFIG_SCHEMA = cv.Schema({
    ...
    cv.Required(CONF_MODBUS_SERVER_ID): cv.use_id(cg.global_ns.namespace("esphome").namespace("modbus_server").class_("ModbusServer")),
    cv.Required(CONF_SENSORBOX_ID): cv.use_id(cg.global_ns.namespace("esphome").namespace("smartevse_sensorbox").class_("SmartEVSESensorBox")),
})
